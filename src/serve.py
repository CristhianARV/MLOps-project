...
@bentoml.service(name="trash_classifier")
class TrashClassifierService:
    bento_model = bentoml.keras.get("trash_classifier_model")
    ...
    def predict(
            self,
            image: Annotated[Image, ContentType("image/jpeg")] = Field(description="Trash image to analyze"),
